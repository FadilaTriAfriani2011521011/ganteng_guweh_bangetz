	...
	<body>
		<div id="step1" class="card shadow mb-4">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<div class="table-responsive">
						...
						<div class="step-buttons flex flex-row-reverse">

							<button onclick="nextStep()" class="btn "
								style="background-color: #0066cc;color: #FFFF;">&#9655;</button>
						</div>
					</div>
				</div>
			...
			<div id="step2" class="card shadow mb-4" style="display: none;">
				<div class="card shadow mb-4">
					<!-- /.card-header-langkah 2 -->
					<div class="card-header py-3">
						<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> Matriks Ternormalisasi (R)
						</h6>
					</div>
				...
				<div id="step3" class="card shadow mb-4" style="display: none;">
					<div class="card shadow mb-4">
						<!-- /.card-header-langkah 3 -->
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> Bobot Preferensi (W)
							</h6>
						</div>
					...
					<div id="step4" class="card shadow mb-4" style="display: none;">
						<div class="card shadow mb-4">
							<!-- /.card-header-langkah4 -->
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> Perhitungan (V)
								</h6>
							</div>
