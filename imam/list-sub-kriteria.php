...
if (isset($_POST['tambah'])) :
	...
	if (!$range_imam) {
		$errors[] = 'Range kriteria tidak boleh kosong';
	}
	// Validasi Tipe
	if (!$nilai) {
	...
	if (empty($errors)) :
		$simpan = mysqli_query($koneksi, "INSERT INTO sub_kriteria (id_sub_kriteria, id_kriteria, nama, range_imam, nilai) VALUES ('', '$id_kriteria', '$nama', '$range_imam', '$nilai')");
...
if (isset($_POST['edit'])) :
	...
	if (empty($errors)) :
		$update = mysqli_query($koneksi, "UPDATE sub_kriteria SET nama = '$nama', range_imam = '$range_imam', nilai = '$nilai' WHERE id_kriteria = '$id_kriteria' AND id_sub_kriteria = '$id_sub_kriteria'");
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-cubes"></i> Data Himpunan Fuzzy</h1>
</div>
...
?>
	<div class="card shadow mb-4">
		...
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> Daftar Data Himpunan Fuzzy</h6>
		</div>
					...
					<div class="modal-content">
						...
						<form action="" method="post">
							<div class="modal-body">
								...
								<div class="form-group">
									<label class="font-weight-bold">Range</label>
									<input autocomplete="off" type="text" class="form-control" name="range_imam" required>
								</div>
								<div class="form-group">
								...
								<tr align="center">
									...
									<td>
										<div class="btn-group" role="group">
											...
											<a data-toggle="tooltip" data-placement="bottom" title="Hapus Data" href="hapus-sub-kriteria.php?id=<?php echo $d['id_sub_kriteria']; ?>" onclick="return confirm ('Apakah anda yakin untuk meghapus data ini')" class="btn btn-primary btn-sm"><i class="fa fa-trash"></i></a>
										</div>
									</td>
								</tr>
								...
								<div class="modal fade" id="editsk<?= $d['id_sub_kriteria'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form action="list-sub-kriteria.php?id_kriteria=<?= $d['id_kriteria']; ?>&id_sub_kriteria=<?= $d['id_sub_kriteria']; ?>" method="post">
												...
												<div class="modal-body">
													...
													<div class="form-group">
														<label class="font-weight-bold">Range</label>
														<input type="text" autocomplete="off" class="form-control" value="<?= $d['range_imam'] ?>" name="range_imam" required>
													</div>
													<div class="form-group">
														<label class="font-weight-bold">Nilai</label>
