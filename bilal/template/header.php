...
<head>
  ...
  <title>SPK Imam, Khatib dan Bilal</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        <div class="sidebar-brand-text mx-3">Surau Tuo Taram</div>
      </a>
      ...
      ?>
        ...
        <li class="nav-item <?php if ($page == "Kriteria") {
          ...
          <a class="nav-link" href="list-kriteria-bilal.php">
        ...
        <li class="nav-item <?php if ($page == "Sub Kriteria") {
          ...
          <a class="nav-link" href="list-him-fuzzy-bl.php">
            <i class="fas fa-fw fa-cubes"></i>
            <span>Himpunan Fuzzy</span></a>
        </li>
        ...
        <li class="nav-item <?php if ($page == "Penilaian") {
          ...
          <a class="nav-link" href="list-penilaian-bl.php">
        ...
        <li class="nav-item <?php if ($page == "Perhitungan") {
          ...
          <a class="nav-link" href="perhitungan-bl.php">
        ...
        <li class="nav-item <?php if ($page == "Hasil") {
          ...
          <a class="nav-link" href="hasil-bl.php">
