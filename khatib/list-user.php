						...
						<tr align="center">
							...
							<td>
								<div class="btn-group" role="group">
									...
									<a data-toggle="tooltip" data-placement="bottom" title="Hapus Data" href="hapus-user.php?id=<?php echo $data['id_user']; ?>" onclick="return confirm ('Apakah anda yakin untuk meghapus data ini')" class="btn btn-primary btn-sm"><i class="fa fa-trash"></i></a>
								</div>
							</td>
						</tr>
					<?php endwhile; ?>
