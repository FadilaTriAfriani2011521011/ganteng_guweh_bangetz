    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      ?>
        ...
        <li class="nav-item <?php if ($page == "Kriteria") {
          ...
          <a class="nav-link" href="list-kriteria-kh.php">
        ...
        <li class="nav-item <?php if ($page == "Sub Kriteria") {
          ...
          <a class="nav-link" href="list-him-fuzzy.php">
        ...
        <li class="nav-item <?php if ($page == "Penilaian") {
          ...
          <a class="nav-link" href="list-penilaian-kh.php">
        ...
        <li class="nav-item <?php if ($page == "Perhitungan") {
          ...
          <a class="nav-link" href="perhitungan-kh.php">
        ...
        <li class="nav-item <?php if ($page == "Hasil") {
          ...
          <a class="nav-link" href="hasil_kh.php">
